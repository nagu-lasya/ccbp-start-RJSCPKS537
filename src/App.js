...
class App extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            <
            h1 class = "details-heading" > Add New Password < /h1>  <
            ...
            div > {
                !isTrue && ( < div className = "empty-state" >
                    <
                    img src = "https://assets.ccbp.in/frontend/react-js/no-passwords-img.png"
                    className = "empty-image"
                    alt = "no  passwords" / >
                    <
                    p className = "no-passwords" > No Password < /p>   < /
                    div >
                )
            } {
                isTrue && ( < ul className = "result-container" > {
                        newList.map(eachValue =>
                            ...
                            isShow && < p className = "website" > {
                                eachValue.password < /p>}  <  /
                                div > <
                                button
                                type = "button"
                                className = "del-btn"
                                onClick = {
                                    () => this.deleteItem(eachValue)
                                }
                                testid = "delete" >
